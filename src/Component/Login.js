...
function Login() {
  ...
  const handleSubmit = async (e) => {
    ...
    try{
      ...
      if(response.data) {
        ...
        window.location.href = "https://ekel.kln.ac.lk/login/index.php";
      } else {
        alert("Invalid username or password");
      }
      //reset from fields after successfull login
      setPassword("");
      setUsername("");
    }catch(error){
  ...
  <div class="title_container">
    ...
    <span class="subtitle">Get started with us, just create an account and enjoy the experience.</span>
  </div>
  <br/>
  <div class="input_container">
    ...
    <input placeholder="Username" title="Inpit title" name="input-name" type="text" class="input_field" id="email_field" value={username} onChange={(e) => setUsername(e.target.value)}/>
  </div>
  <div class="input_container">
    ...
    <input placeholder="Password" title="Inpit title" name="input-name" type="password" class="input_field" id="password_field" value={password} onChange={(e) => setPassword(e.target.value)}/>
  </div>
  <button title="Sign In" type="submit" class="sign-in_btn">
    <span>Sign In</span>
  </button>
  <div>
  <p class="link">Don't have an account?<a href="" class="link"> Sign up now</a></p>
